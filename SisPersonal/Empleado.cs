namespace EspacioEmpleado
{
    ...
    {
        public enum Cargo // enum de los posibles cargos
        {
            Auxiliar,
            Administrativo,
            Ingeniero,
        ...
        public Empleado(string nombre, string apellido, DateTime fechaNacimiento, char estadoCivil, DateTime fechaIngreso, double sueldo, Cargo cargo) // Constructor de la clase Empleado
        {
            this.nombre = nombre; // this es porque el nombre del campo y el del dato argumento son iguales y puede haber haber ambiguedad
        ...
        public void MostrarDatos() // metodo para mostra Datos
        {
            Console.WriteLine("--------------------------------------");
